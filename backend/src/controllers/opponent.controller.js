...
const createOpponent = async (req, res, next) => {
  try {
    ...
    const opponent = await opponentService.createOpponent(opponentData, userId);
...
const updateOpponent = async (req, res, next) => {
  try {
    ...
    const updatedOpponent = await opponentService.updateOpponent(id, opponentData, userId, userRole);
...
const deleteOpponent = async (req, res, next) => {
  try {
    ...
    await opponentService.deleteOpponent(id, userId, userRole);
